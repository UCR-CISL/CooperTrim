...
def eval_final_results(result_stat, save_path, global_sort_detections,fromTrain =False,writer=None,epoch=None):
    dump_dict = {}
    ...
    if writer is not None:
        writer.add_scalar('IOU_0.5', ap_50,epoch)
        writer.add_scalar('IOU_0.7', ap_70,epoch)