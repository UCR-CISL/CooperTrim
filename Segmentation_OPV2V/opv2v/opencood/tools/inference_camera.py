...
def main():
    ...
    # with open("/home/csgrad/smukh039/AutoNetworkingRL/CoBEVT_AutoNet/opv2v/dumps_channel_select/dummy.txt", "w") as f:
    with open("/home/csgrad/smukh039/AutoNetworkingRL/CoBEVT_AutoNet/opv2v/dumps_channel_select/coopertrim_cobevt_st_compress8_iou.txt", "w") as f:
        for i, batch_data in enumerate(data_loader):
            print(i)
            with torch.no_grad():
                # torch.cuda.synchronize()
