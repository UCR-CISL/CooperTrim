...
from opencood.models.sub_modules.fax_modules_SwissCheese import FAXModule_SwissCheese
...
class SwissCheese(nn.Module):
    def __init__(self, config):
        super(SwissCheese, self).__init__()
        ...
        self.fax = FAXModule_SwissCheese(fax_params)
    ...
    def forward(self, batch_dict):
        ...
        return output_dict, select_threshold, percentage_selected